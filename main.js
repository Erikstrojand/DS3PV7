...
let player = {
    cash: 1_000_000_000,
    properties: { "Dogok-dong": { district: "Gangnam-gu", purchasePrice: 500_000_000, building: null } }
};
...
function triggerRandomEvent() {
    const randomEvents = [priceSpikeEvent, priceDropEvent, buildingDamageEvent];
    const weights = [4, 4, 2]; //eights to control likelihood
...
        let effectiveIncome = Math.floor(building.income * (building.condition / 1000));
...
            console.log("Building drawPos:", building._drawPos);
        }
    }
